...
// cargo run --release --example mosse $(ls ./res/webcam*.png)
...
fn main() {
    ...
    let window_size = 96; //size of the tracking window
    ...
    let target_coords = vec![(100, 40), (540, 94), (13, 283), (475, 400), (283, 365)];
    ...
    for (i, dyn_img) in images.enumerate() {
        ...
        img_copy
            .save(format!("out/predicted_image_{}.png", img_id))
            .unwrap();
